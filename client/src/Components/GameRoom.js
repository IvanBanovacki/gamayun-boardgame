...
const GameRoom = () => {
  ...
  //const ENDPOINT = "https://gamayun-triviaboardgame-server.herokuapp.com/";
  // const ENDPOINT = "https://server-gamayun.herokuapp.com/";
  ...
  const getSingleQA = (category, diff, players) => {
    console.log(category, diff, players);
